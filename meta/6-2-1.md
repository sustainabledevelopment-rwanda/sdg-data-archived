...
national_indicator_available: <p> (a)	Percent distribution of households and de jure population by type of toilet/latrine facilities, according to residence; Improved, not shared facility, Shared facility, Non-improved facility.</p> (b)	Hand washing; Among households where place for hand washing was observed, percentage with: Soap and water 
...
computation_disaggregation: <p>National, Province, District & Residence (Urban, Rural), Types of improved sanitation facility and habitat, Sex of head of household, Consumption quintile, disability status.</p> Handwashing; Province, Residence (Urban, Rural), Wealth Quintile
